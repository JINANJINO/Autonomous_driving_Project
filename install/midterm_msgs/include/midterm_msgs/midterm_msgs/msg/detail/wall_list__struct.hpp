...
struct WallList_
{
  ...
  using _walls_type =
    std::vector<midterm_msgs::msg::Wall_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<midterm_msgs::msg::Wall_<ContainerAllocator>>>;
  _walls_type walls;

  // setters for named parameter idiom
  Type & set__walls(
    const std::vector<midterm_msgs::msg::Wall_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<midterm_msgs::msg::Wall_<ContainerAllocator>>> & _arg)
  {
    this->walls = _arg;
    return *this;
  }
