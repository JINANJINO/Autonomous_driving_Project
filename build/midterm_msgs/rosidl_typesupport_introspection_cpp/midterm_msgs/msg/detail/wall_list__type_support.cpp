...
void fetch_function__WallList__walls(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const midterm_msgs::msg::Wall *>(
    get_const_function__WallList__walls(untyped_member, index));
  auto & value = *reinterpret_cast<midterm_msgs::msg::Wall *>(untyped_value);
  value = item;
}

void assign_function__WallList__walls(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<midterm_msgs::msg::Wall *>(
    get_function__WallList__walls(untyped_member, index));
  const auto & value = *reinterpret_cast<const midterm_msgs::msg::Wall *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WallList_message_member_array[1] = {
  {
    ...
    fetch_function__WallList__walls,  // fetch(index, &value) function pointer
    assign_function__WallList__walls,  // assign(index, value) function pointer
