...
void fetch_function__SimpleLidar__beams(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__SimpleLidar__beams(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__SimpleLidar__beams(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__SimpleLidar__beams(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SimpleLidar_message_member_array[1] = {
  {
    ...
    fetch_function__SimpleLidar__beams,  // fetch(index, &value) function pointer
    assign_function__SimpleLidar__beams,  // assign(index, value) function pointer
