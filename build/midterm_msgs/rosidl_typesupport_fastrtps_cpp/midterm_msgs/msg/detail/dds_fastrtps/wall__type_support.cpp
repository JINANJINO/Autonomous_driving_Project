...
#include "midterm_msgs/msg/detail/wall__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const midterm_msgs::msg::Wall & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  midterm_msgs::msg::Wall & ros_message)
{
  // Member: bl_x
  cdr >> ros_message.bl_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = midterm_msgs::msg::Wall;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const midterm_msgs::msg::Wall *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<midterm_msgs::msg::Wall *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Wall__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const midterm_msgs::msg::Wall *>(
...
static size_t _Wall__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Wall(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Wall__callbacks = {
  "midterm_msgs::msg",
  "Wall",
...
static rosidl_message_type_support_t _Wall__handle = {
...
{
  return &midterm_msgs::msg::typesupport_fastrtps_cpp::_Wall__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, midterm_msgs, msg, Wall)() {
  return &midterm_msgs::msg::typesupport_fastrtps_cpp::_Wall__handle;
}
