...
#include "midterm_msgs/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const midterm_msgs::msg::Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  midterm_msgs::msg::Goal & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = midterm_msgs::msg::Goal;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const midterm_msgs::msg::Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<midterm_msgs::msg::Goal *>(
    untyped_ros_message);
...
{
  return &midterm_msgs::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, midterm_msgs, msg, Goal)() {
  return &midterm_msgs::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
