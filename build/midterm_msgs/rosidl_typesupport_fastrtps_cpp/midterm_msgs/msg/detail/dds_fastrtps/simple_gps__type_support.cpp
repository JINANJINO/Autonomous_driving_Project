  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = midterm_msgs::msg::SimpleGPS;
    is_plain =
      (
...
static size_t _SimpleGPS__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_SimpleGPS(full_bounded, is_plain, 0);
