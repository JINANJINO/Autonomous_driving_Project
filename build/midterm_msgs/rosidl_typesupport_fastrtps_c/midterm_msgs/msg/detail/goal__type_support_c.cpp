...
#include "midterm_msgs/msg/detail/goal__rosidl_typesupport_fastrtps_c.h"
...
using _Goal__ros_msg_type = midterm_msgs__msg__Goal;
...
size_t get_serialized_size_midterm_msgs__msg__Goal(
  const void * untyped_ros_message,
...
static uint32_t _Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_midterm_msgs__msg__Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_midterm_msgs
size_t max_serialized_size_midterm_msgs__msg__Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = midterm_msgs__msg__Goal;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_midterm_msgs__msg__Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, midterm_msgs, msg, Goal)() {
